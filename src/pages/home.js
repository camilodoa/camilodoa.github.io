    ...
    <Container className='my-2 mb-4 pb-4'>
      <Row className='justify my-2 justify-content-md-center'>
        <Col md={'8'} className='mx-4'>
          ...
          <p className='my-4'>
            My interests lie in the space between machine learning, web development, and contemporary art. Right now I'm using AI techniques
            to predict future ICE raids in the US.
          </p>
          <p className='my-2'>
      ...
      <Project
        ...
        description={
          'is a web app designed to source and visualize\n' +
      ...
      <Row className='align justify mb-3 justify-content-md-center'>
        <Col md={8}>
          ...
          <p className='my-4'>
            <b>Dra</b>{' '}
            {'is a deep learning agent that lives in your browser. Over time, it\n' +
