...
export default function Trunk () {
  ...
  return (
    <Container className='my-2 top'>
      ...
      <Row className='align justify my-4 justify-content-md-center'>
        <Col lg={8}>
          <Image alt='slepton' src={projects + 'lunarbaby.png'} fluid></Image>
          <h4 className='my-4'>
            <b><a href="https://lunarbaby.ml"
                  rel="noopener noreferrer" target="_blank">lunarbaby.ml</a>
            </b>
          </h4>
          <p className='my-4'>
            <b>Ra</b> is a q-learning agent that exists in your browser. It
            learns to approach the concentric circles in the center of the page. By tapping
            on the screen, you change the location of these circles and restructure Ra's world.
          </p>
        </Col>
      </Row>
      <Row className='align justify my-4 justify-content-md-center'>
